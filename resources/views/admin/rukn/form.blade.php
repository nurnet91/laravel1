...
<section class="content">
	...
	<div class="row" style="padding-top:20px;">
        ...
        {{ Form::model($model, ['url' => $action_link, 'class' => 'form-horizontal', 'files' => true]) }}
            ...
            <div class="form-group">
              <label for="asosiy" class="col-sm-2 control-label">Asosiyligi</label>
              <div class="col-sm-10" style="padding-top: 7px;">
                {{ Form::checkbox('asosiy', null, isset($model->asosiy) ? $model->asosiy : false, ['class' => 'flat-red', 'id' => 'asosiy']) }}
              </div>
            </div>

			      <div class="form-group">
              <label for="sahifa" class="col-sm-2 control-label">Bosh sahifada chiqishi</label>
              <div class="col-sm-10" style="padding-top: 7px;">
                {{ Form::checkbox('sahifa', null, isset($model->sahifa) ? $model->sahifa : false, ['class' => 'flat-red', 'id' => 'sahifa']) }}
              </div>
            </div>
